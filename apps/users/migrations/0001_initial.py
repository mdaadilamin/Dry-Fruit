    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('admin', 'Administrator'), ('employee', 'Employee'), ('customer', 'Customer')], max_length=20, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('module', models.CharField(choices=[('products', 'Products'), ('orders', 'Orders'), ('customers', 'Customers'), ('employees', 'Employees'), ('reports', 'Reports'), ('cms', 'Content Management')], max_length=20)),
